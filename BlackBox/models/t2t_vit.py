...
class T2T_ViT(nn.Module):
    def __init__(self, img_size=224, tokens_type='performer', in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 drop_path_rate=0., norm_layer=nn.LayerNorm, token_dim=64, first_keep_rate=1.):
        super().__init__()
        ...
        keep_rat=[1. for i in range(depth)]
        keep_rat[0]=first_keep_rate
        self.blocks = nn.Sequential(*[
            Block(keep_rate=keep_rat[i],
