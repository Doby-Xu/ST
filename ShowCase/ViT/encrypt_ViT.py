...
Different models have different names for the parameters, so we need to change the names in the code accordingly. Print the names and shapes of the parameters, find the corresponding names and modify the code accordingly.
'''
